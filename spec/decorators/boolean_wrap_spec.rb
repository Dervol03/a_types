...
describe ATypes::BooleanWrap do
  subject { described_class.new('y') }

  let(:positive_bool) { described_class.new(true)  }
  let(:negative_bool) { described_class.new(false) }
  ...
  describe '#&' do
    context 'other has #truth understanding' do
      it 'performs logical AND operation with other' do
        expect(positive_bool & described_class.new(true)).to be true
        expect(positive_bool & described_class.new(false)).to be false

        expect(negative_bool & described_class.new(true)).to be false
        expect(negative_bool & described_class.new(false)).to be false
      end
  ...
  describe '#|' do
    context 'other has #truth understanding' do
      it 'performs logical OR operation with other' do
        expect(positive_bool | described_class.new(true)).to be true
        expect(positive_bool | described_class.new(false)).to be true

        expect(negative_bool | described_class.new(true)).to be true
        expect(negative_bool | described_class.new(false)).to be false
      end
    end # other has #truth understanding
  ...
  describe '#^' do
    context 'other has #truth understanding' do
      it 'performs logical XOR operation with other' do
        expect(positive_bool ^ described_class.new(true)).to be false
        expect(positive_bool ^ described_class.new(false)).to be true
